...
blocks = [0.3, 0.3, 0, 0.2, 0.2, 0.3;
          -0.5, 0.7, 0, 0.3, 0.3, 0.25;
          0.6, -0.2, 0, 0.3, 0.3, 0.35;
          -0.8, -0.8, 0, 0.3, 0.3, 0.4;
          1.1, 0.8, 0, 0.4, 0.4, 0.35];
...
% PD Controller gains
Kp = 5.0; % Increased Proportional gain for better response
Kd = 2.0; % Increased Derivative gain to reduce oscillations
...
for iter = 1:max_iter
    ...
    theta = theta + dt * theta_dot' + 0.5 * dt^2 * theta_ddot';
